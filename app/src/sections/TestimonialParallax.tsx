...
const testimonials = [
  ...
  {
    quote: 'Three other agencies had failed before AURUM succeeded. They understand that at this level, it\'s not just about the property — it\'s about the life it enables.',
    author: 'S.M.',
